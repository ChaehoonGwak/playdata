...
char_dict = string.ascii_lowercase # 소문자로 이루어진 리스트 생성
answer = 0
hash_val = [31**i for i in range(51)] # 문자열 최대길이는 50이므로 50까지 hash_val 연산

for idx, c in enumerate(s):
    answer += (char_dict.find(c)+1)*hash_val[idx] # 해당 알파벳 소문자 값과 해쉬값을 곱하여 결과에 더함

answer %= 1234567891 # 1234567891 M의 값 나누어 줌
print(answer)
